...
public class AbsEnrichedEdgeTest {
    ...
    public void testGetCoordinate() throws Exception {
         assertEquals(coordinate,defaultEdge.getCoordinate());
    }

    @Test
    public void testGetDistance() throws Exception {
        assertEquals(distance,defaultEdge.getDistance(),0.01);
    }
    ...
    public void testGetEndPoint() throws Exception {
        assertEquals(endROI,defaultEdge.getEndPoint());
    }
    ...
    public void testGetId() throws Exception {
        assertEquals(edgeID,defaultEdge.getId());
    }
     ...
     */
    @Test
    public void testGetNavigationInformation() throws Exception {
        assertEquals(navInfo,defaultEdge.getNavigationInformation());
    }
    ...
    public void testGetPhotoInformation() throws Exception {
        URI uris[] = {new URI("www.google.com"),new URI("www.apple.com")};
        Collection<PhotoRef> photoRefCollection = defaultEdge.getPhotoInformation().getPhotoInformation();
        int i=0;
        for(PhotoRef p:photoRefCollection){
            assertEquals(p.getPhotoUri(),uris[i]);
            i++;
        }
     ...
     */
    @Test
    public void testGetStarterPoint() throws Exception {
        assertEquals(startROI,defaultEdge.getStarterPoint());
    }
